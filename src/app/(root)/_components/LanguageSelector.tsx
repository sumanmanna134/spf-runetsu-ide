...
function LanguageSelector({ hasAccess }: { hasAccess: boolean }) {
    ...
    const handleLanguageSelect = (langId: string) => {
        if (!hasAccess && langId !== DEFAULT_EDITOR_CONFIG.language) return;
        setLanguage(langId);
        setIsOpen(false);
    }
    ...
    return (
        <div className="relative" ref={dropDownRef}>
            ...
            >
                ...
                <ChevronDownIcon className={`size-4 text-gray-400 transition-all duration-300 group-hover:text-gray-200
                        ${isOpen ? "rotate-180" : ""}
                `
                ...
                >
                    ...
                    <div className="max-h-[280px] overflow-y-auto overflow-x-hidden">
                        {Object.values(LANGUAGE_CONFIG).map((lang, index) => {
                            const isLocked = !hasAccess && lang.id !== DEFAULT_EDITOR_CONFIG.language;
